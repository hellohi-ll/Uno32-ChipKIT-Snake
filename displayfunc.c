/* mipslab.h
   ...
   This file modified 2022-03-03 by
  ...
  if (status) {
    switch(row % 8){
      ...
      case 1:
        ...
        break;
      case 2: select = 0xFB; // 0b11111011
        break;
      case 3: select = 0xF7; // 0b11110111
        break;
      case 4: select = 0xEF; // 0b11101111
        break;
      case 5: select = 0xDF; // 0b11011111
        break;
      case 6: select = 0xBF; // 0b10111111
        break;
      case 7: select = 0x7F; // 0b01111111
        break;
      default: return;
    }
  } else {
    switch(row % 8){
      case 0: select = 0x01; // 0b00000001
        break;
      case 1: select = 0x02; // 0b00000010
        break;
      case 2: select = 0x04; // 0b00000100
        break;
      case 3: select = 0x08; // 0b00001000
        break;
      case 4: select = 0x10; // 0b00010000
        break;
      case 5: select = 0x20; // 0b00100000
        break;
      case 6: select = 0x40; // 0b01000000
        break;
      case 7: select = 0x80; // 0b10000000
        break;
      default: return;
    }
  }
